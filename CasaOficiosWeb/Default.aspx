...
<div class="form-group"> 
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
    <!-- select name="state" class="form-control selectpicker" -->
    <asp:DropDownList ID="DropDownListOficios" CssClass="form-control selectpicker" runat="server" >
...
<div class="form-group">
  ...
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <!--input  name="first_name" placeholder="Contacto" class="form-control"  type="text"-->
  <asp:TextBox type="text" runat="server" id="txtSearchTerm" CssClass="form-control" PlaceHolder="Contacto"></asp:TextBox>
    </div>
  </div>
...
<div class="form-group">
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
        	<!--textarea class="form-control" name="comment" placeholder="Describenos su urgencia"></!textarea-->
           <asp:TextBox type="text" TextMode="multiline" runat="server" id="Descripcion" CssClass="form-control" PlaceHolder="Describenos su urgencia"></asp:TextBox>
...
<div class="form-group">
    ...
    <div class="input-group">
        ...
        <asp:FileUpload ID="foto" runat="server" CssClass="form-control" placeholder="Foto"></asp:FileUpload>
...
<div class="form-group">
  <div class="col-md-8" >
    ...
    <asp:Button type="submit" runat="server" CssClass="btn btn-primary center-block" id="btnSubmit" Text="Enviar"> 
            ...
            <div class="row">
                <div class="col-sm-6 wow fadeInDown">
                    <div class="skill">
                        ...
                        <p>
                        Tenemos una larga lista de especialista para tu necesidad, donde la mayoría cuenta con la probación de nuestros usuarios del servicios.
                        ...
                        <div class="progress-wrap">
                            <h3>Gasfiteros</h3>
                            <div class="progress">
                              <div class="progress-bar  color1" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 94%">
                                <span class="bar-width">94%</span>
                              </div>
                        ...
                        <div class="progress-wrap">
                            <h3>Albañiles</h3>
                            <div class="progress">
                              <div class="progress-bar color3" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 93%">
