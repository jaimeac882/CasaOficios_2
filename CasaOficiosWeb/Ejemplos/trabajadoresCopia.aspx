<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="trabajadoresCopia.aspx.cs" Inherits="CasaOficiosWeb.trabajadoresCopia" %>
...
<head runat="server">
    ...
    <script language="javascript">
        ...
        AddItem(nuevoCodigo, descripcionItem);
        AddItemListBox1(nuevoCodigo, descripcionItem);
        ...
        function AddItem(Text, Value) {
            ...
            document.getElementById("lstTelefonoAgregados").options.add(opt);
        ...
        function AddItemListBox1(Text, Value) {
            // Create an Option object
        ...
        function borrarItemTelefono()
        {
            ...
            {                
                $('#lstTelefonoAgregados option:selected').each(function (i, selected) {
                    if (arrayFonos[i] == telefono) {                        
	...
	<div class="row">
		    <div class="col-md-8">
                    ...
                    <div class="card">
                                    ...
                                    <!-- Tab panes -->
                                    <div id="Tabs" role="tabpanel" class="tab-content" class="col-md-8 inputGroupContainer">
...
//in this line of code, to display the datetimepicker,  we used â€˜form_datetimeâ€™ as an argument to be 
    ...
    $(function () {
        var tabName = $("[id*=TabName]").val() != "" ? $("[id*=TabName]").val() : "profile";
